...
function Media() {
  ...
  const dailyReportData = blogData.filter(
    (item) => item.category === "Daily Report"
  );
  ...
  function updateMetaTags() {
    ...
    let title = "FiYDAA Insights | Latest Media from FiYDAA";
    let description = "Top media from the world of gold investments and stock market for first-time and experienced investors";
                      ...
                      <div className="mt-auto">
                        <div className="flex justify-between items-center">
                          ...
                          <Link
                            ...
                            target='_blank'
                            className="font-outfit text-black cursor-pointer font-bold font-poppins"
                          >
                            Read More
                          </Link>
                        </div>
